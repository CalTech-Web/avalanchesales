export const company = {
  ...
  tagline: "Exclusive Leads. Real Customers. Predictable Growth.",
  secondaryTagline: "Human Verified! AI Empowered Data & Leads!",
};
...
export const footerQuickLinks = [
  ...
  { label: "Services", href: "/services/" },
  { label: "Schedule A Call", href: "/schedule-call-today/" },
...
export const platforms = [
  ...
  { name: "Bing Ads", category: "Search", reach: "Reaches 1.2 billion global unique users", icon: "/images/products/bing-ads-icon.jpg" },
